...
const tourSchema = new mongoose.Schema(
    {
        name: {
            ...
            maxlength: [
                40,
                'A tour name nust have less or equeal then 40 characters',
            ],
            minlength: [
                10,
                'A tour name nust have more or equeal then 10 characters',
            ],
            // validate: [
            //     validator.isAlpha,
...
// document middleware: runs before .save() and .create() {{{not .insertMany() || not update !!!}}}
